...
#define SSID1 "atoi()_Wi-Fi5"
#define PWD1 "33184699"
...
void mjpegCB(void* pvParameters) {
  ...
  server.on("/leftSpin", HTTP_GET, leftSpin);
  server.on("/rightSpin", HTTP_GET, rightSpin);
  server.on("/lightsOn", HTTP_GET, lightsOn);
...
void forward() {
  ...
  digitalWrite(14, LOW);
  Serial.println("Moving Forward for 0.1s");
  delay(100);
  stopMoving();
}
...
void backward() {
  ...
  Serial.println("Moving backward for 0.1s");
  delay(100);
  stopMoving();
}
...
void leftSpin() {
  ...
  Serial.println("Spinning Left for 0.1s");
...
void rightSpin() {
  ...
  digitalWrite(14, LOW);
  delay(100);
  Serial.println("Spinning Right for 0.1s");
  stopMoving();
}
